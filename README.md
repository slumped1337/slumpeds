...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/slumped1337/slumpeds proxy/tree/master)

## Running locally

```sh
git clone https://github.com/slumped1337/slumpeds proxy.git
cd slumps
node server.js
```
